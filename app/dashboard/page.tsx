...
export default function AdminDashboard() {
  ...
  const { team1, team2, stats, isGameStarted, isHalfTime, isGameEnded, currentTime } = gameState
        ...
        <CardContent>
          <Tabs defaultValue={team1}>
            <TabsList className="grid w-full grid-cols-2 mb-6">
              <TabsTrigger
                value={team1}
                className={`text-white transition-colors ${teamColors[team1]} data-[state=active]:${teamColors[team1]} data-[state=active]:text-white`}
              >
                {team1}
              </TabsTrigger>
              <TabsTrigger
                value={team2}
                className={`text-white transition-colors ${teamColors[team2]} data-[state=active]:${teamColors[team2]} data-[state=active]:text-white`}
              >
                {team2}
              </TabsTrigger>
            </TabsList>
